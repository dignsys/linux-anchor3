%define config_name nxp3220_anchor3_tizen_defconfig
%define buildarch arm
%define target_board anchor3
%define variant %{target_board}
%define vendor_name dignsys

Name: linux-anchor3
Summary: The Linux Kernel for Anchor3
Version: 4.14.73
Release: 0
License: GPL-2.0
ExclusiveArch: %{arm}
...
install -m 644 arch/arm/boot/dts/nxp3220-anchor3.dtb %{buildroot}/boot/
