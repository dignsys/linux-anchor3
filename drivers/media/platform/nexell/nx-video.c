...
static int nx_video_cropcap(struct file *file, void *fh, struct v4l2_cropcap *a)
{
	...
	struct v4l2_rect *rect = &a->bounds;
	...
	v4l2_subdev_call(subdev, video, g_pixelaspect, &a->pixelaspect);
			     ...
			     const struct v4l2_crop *a)
{
	...
	sel.r = a->c;
	return v4l2_subdev_call(subdev, pad, set_selection, NULL, &sel);
}
			   ...
			   struct v4l2_control *ctrl)
{
	...
	return v4l2_g_ctrl(subdev->ctrl_handler, ctrl);
}
			   ...
			   struct v4l2_control *ctrl)
{
	...
	return v4l2_s_ctrl(NULL, subdev->ctrl_handler, ctrl);
}
...
static const struct v4l2_ioctl_ops nx_video_ioctl_ops = {
...
struct nx_video_buffer *nx_video_get_next_buffer(
		struct nx_video_buffer_object *obj, bool remove)
{
	unsigned long flags;
